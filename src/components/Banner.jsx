export default function Banner() {
  return (
    <div className="hero min-h-[60vh] md:min-h-[70vh] bg-purple-50 my-6 rounded-[2rem] max-w-7xl mx-auto px-4 sm:px-8 md:px-12 py-8 md:py-0">
      <div className="hero-content flex-col lg:flex-row-reverse text-center lg:text-left gap-8 md:gap-10">
        <img
          src="https://i.ibb.co.com/twD7fCYQ/banner.png"
          className="max-w-[280px] sm:max-w-sm md:max-w-md lg:max-w-lg rounded-2xl shadow-2xl"
          alt="Digital Tools"
        />
        <div className="lg:pr-10 flex flex-col items-center lg:items-start">
          <div className="badge badge-success rounded-full bg-[#E1E7FF] border-none shadow-sm p-3 md:p-4 mb-4 md:mb-6 gap-2 flex items-center">
            <svg width="14" height="14" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 md:w-4 md:h-4">
            ...
            <span className="bg-gradient-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent font-bold text-xs md:text-sm">
              New: AI-Powered Tools Available
            </span>
          </div>
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-bold leading-tight text-gray-800">
            Supercharge Your<br className="hidden sm:block" /> Digital Workflow
          </h1>
          <p className="py-4 md:py-6 text-gray-500 max-w-md text-sm md:text-base px-2 lg:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start w-full sm:w-auto mt-2">
            <button className="btn bg-gradient-to-r from-[#4F39F6] to-[#9514FA] border-none text-white px-6 md:px-8 rounded-full text-base md:text-lg shadow-lg hover:opacity-90 transition-all w-full sm:w-auto h-12">
              Explore Products
            </button>
            <button className="btn btn-outline border-purple-600 text-purple-600 hover:bg-purple-50 hover:text-purple-700 rounded-full flex gap-2 px-6 shadow-sm w-full sm:w-auto h-12">
              <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-4.5 h-4.5 md:w-5 md:h-5">
