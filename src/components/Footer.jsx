export default function Footer() {
  return (
    <footer className="w-full">
      ...
      {/* Main Footer */}
      <div className="bg-[#0B1120] text-gray-400 py-16 px-6 md:px-16 border-t border-gray-800">
        <div className="footer max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
